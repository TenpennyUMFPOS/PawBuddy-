...
import 'package:project_integration_pb/core/enums/enums.dart';
import 'package:project_integration_pb/features/auth/controller/auth_controller.dart';

import 'package:project_integration_pb/features/post/repository/post_repository.dart';
import 'package:project_integration_pb/features/user_profile/controller/user_profile_controller.dart';
import 'package:project_integration_pb/models/community_model.dart';
import 'package:project_integration_pb/models/post_model.dart';
...
class PostController extends StateNotifier<bool> {
  ...
  void shareDemandPost({
    ...
    final res = await _postRepository.addPost(post);
    _ref.read(userProfileControllerProvider.notifier).updateUserKarma(UserKarma.demandPost);
  ...
  void deletePost(Post post, BuildContext context) async{
    ...
    res.fold((l) => null, (r) => showSnackBar(context,'Post deleted Succsessfully!'));
  }
